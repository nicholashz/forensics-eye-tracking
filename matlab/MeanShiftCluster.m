...
while numInitPts
    ...
    %plot the current cluster centers to see if they change over time
    for thiscluster = 1 : size(clustCent,2)
       plot(clustCent(1,thiscluster), clustCent(2,thiscluster), 'sk'); 
    end
    pause(.5);
            end    
